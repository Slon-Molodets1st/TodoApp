...
Приложение для создание списка задач и управление им с бэкендом на **Python (FastAPI)** и фронтендом на **TypeScript (React)**.
...
**Тестирование:**
- [Pytest](https://pytest.org/) — тестирование бэкенда
